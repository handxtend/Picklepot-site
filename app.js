...
(function(){
  ...
  async function startCreatePotCheckout(){ try { if (typeof onCreateClick==='function') return onCreateClick(); } catch(e){ console.error('[CREATE]', e); } }
